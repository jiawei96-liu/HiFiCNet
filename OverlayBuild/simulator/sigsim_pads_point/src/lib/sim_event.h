...
struct sim_event_host_add * sim_event_host_add_new(struct node * rt,uint64_t time,uint32_t ip,uint32_t netmask,uint8_t eth_addr[ETH_LEN],char * device_id);
struct sim_event_host_del * sim_event_host_del_new(char * device_id,uint64_t time);
